 ...
 * @Description: 该对象用于后台操作后返回给前台数据
 * 				   例如做对象添加、删除 成功后 返回状态码200
 * 				 if(data.status == 200){
$.messager.alert('提示','新增商品成功!');
 * @author yesyoungbaby
 * @date 2018年7月17日 下午8:42:20
 */
public class ResponseResult implements Serializable {
    ...
    //静态方法
    public static ResponseResult build(Integer status, String msg, Object data) { return new ResponseResult(status, msg, data); }
